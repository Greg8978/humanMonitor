...
int main(int argc, char** argv){
  ...
  while( node.ok() ){
	...
	wasPresent=1;
      ...
      rHipJoint= humanRd.m_LastConfig[0].skeleton.joint[niut_RIGHT_HIP];
	...
	m_HumanLastConfig[humanRHip] = rHipJointW;
      }
